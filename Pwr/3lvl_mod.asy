...
SYMATTR Description 3-phase, 3-lvl modulation, internal carrier of +/-{Vpk} [V] amplitude and {f} [Hz], {a} sets the skewness. f=0 disables internal carrier. {dt} [s] dead-time, {Vhigh}/{Vlow} logic output levels. Hidden {td} (delay), {vh} (hysteresis), {tripdt}.
SYMATTR SpiceLine Vhigh=1 Vlow=0
SYMATTR SpiceLine2 Vpk=1 f=1k dt=1u a=0.5
