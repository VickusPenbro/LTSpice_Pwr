...
TEXT 0 -48 Center 2 SINPWM
WINDOW 0 -64 -88 Left 2
SYMATTR Prefix x
SYMATTR SpiceModel SINPWM
SYMATTR SpiceLine f=2k sym=0.5 Vhigh=1 Vlow=0
SYMATTR SpiceLine2 dt=1u td=1u Vpk=1
SYMATTR Description Sinusoidal PWM. Alpha-beta input reconstructed into three pure sinusoidal phase references, compared against a bipolar triangular carrier. {f} [Hz] carrier, sym=<1m..999m> controls its symmetry, {Vpk} [V] carrier peak, {Vhigh/Vlow} [V] output logic levels, {dt} [s] dead-time.
